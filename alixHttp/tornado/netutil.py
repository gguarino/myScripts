...
if hasattr(ssl, 'match_hostname') and hasattr(ssl, 'CertificateError'):  # python 3.2+
    ...
    import utils.backports.ssl_match_hostname
    ssl_match_hostname = utils.backports.ssl_match_hostname.match_hostname
    SSLCertificateError = utils.backports.ssl_match_hostname.CertificateError
